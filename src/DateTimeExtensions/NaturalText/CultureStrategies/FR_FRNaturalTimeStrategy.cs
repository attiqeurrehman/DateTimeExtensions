...
namespace DateTimeExtensions.NaturalText.CultureStrategies
{
    ...
    {
        protected override string YearText => "année";

        protected override string MonthText => "mois";

        protected override string DayText => "jour";

        protected override string HourText => "heure";
